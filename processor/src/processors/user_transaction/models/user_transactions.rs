    ...
    pub fn from_transaction(
        ...
        (
            Self {
                ...
                sequence_number: replay_protection_nonce.is_none().then_some(user_request.sequence_number as i64),
...
impl From<UserTransaction> for ParquetUserTransaction {
    fn from(user_transaction: UserTransaction) -> Self {
        Self {
            ...
            replay_protection_nonce: user_transaction.replay_protection_nonce.map(|n| n.to_string()),
