...
pub trait ObjectConvertible {
    fn from_base(base_item: ObjectBase) -> Self;
}

#[derive(Clone, Debug, Deserialize, FieldCount, Serialize)]
pub struct CurrentObjectBase {
    pub object_address: String,
    pub owner_address: String,
    pub state_key_hash: String,
    pub allow_ungated_transfer: bool,
...
pub trait CurrentObjectConvertible {
    fn from_base(base_item: CurrentObjectBase) -> Self;
}
...
impl ObjectBase {
    ...
    ) -> anyhow::Result<Option<(Self, CurrentObjectBase)>> {
    ...
    pub async fn from_delete_resource(
        ...
        txn_version: i64,
        write_set_change_index: i64,
        object_mapping: &AHashMap<CurrentObjectPK, CurrentObjectBase>,
